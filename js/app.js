 ...
 */
    ...
    (() => {
        ...
        let maskPhone = document.getElementById("tel");
        ...
        const buttonVideo = document.querySelector(".video__image");
        ...
        if (video) buttonPlay.addEventListener("click", (function(e) {
            buttonVideo.classList.toggle("poster__none");
