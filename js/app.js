 ...
 */
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    menu.classList.toggle("_menu-snow");
                    menuList.classList.toggle("_menu-lock");
                    const headerLink = document.querySelectorAll(".header-link");
                    for (let i = 0; i < headerLink.length; i++) headerLink[i].addEventListener("click", (function(e) {
                        menu.classList.remove("_menu-snow");
                        menuList.classList.remove("_menu-lock");
        ...
        let maskPhone = document.querySelectorAll("#tel");
        for (let index = 0; index < maskPhone.length; index++) {
            let im = new Inputmask("+9-999-999-99-999");
            im.mask(maskPhone);
        }
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) new core(".swiper", {
                ...
                speed: 800,
                pagination: {
                    el: ".video-tabs__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".video-tabs__prev",
                    nextEl: ".video-tabs__next"
                },
                on: {}
            });
        }
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                if (subMenu) {
                    const activeLink = document.querySelector("._menu-link-active");
                    const activeBlock = document.querySelector("._menu-link-open");
                    if (activeLink && activeLink !== targetElement) {
                        activeLink.classList.remove("_menu-link-active");
                        activeBlock.classList.remove("_menu-link-open");
                        document.documentElement.classList.remove("menu-link-open");
                    }
                    document.documentElement.classList.toggle("menu-link-open");
                    targetElement.classList.toggle("_menu-link-active");
                    subMenu.classList.toggle("_menu-link-open");
                } else console.log("Нет такого");
                e.preventDefault();
            }
        }
        const poseterVideo = document.querySelector(".video__image");
        const video = document.querySelector(".video__redacted");
        const buttonPlay = document.querySelector(".video__play");
        const section = document.querySelector(".video");
        if (video) {
            if (video.paused) buttonPlay.addEventListener("click", (function(e) {
                poseterVideo.classList.toggle("poster__none");
                buttonPlay.classList.toggle("poster__none");
                section.classList.toggle("background__off");
                video.play();
            }));
            if (video.play) video.addEventListener("click", (function(e) {
                poseterVideo.classList.remove("poster__none");
                buttonPlay.classList.remove("poster__none");
                section.classList.remove("background__off");
            }));
        }
        const popupButton = document.querySelectorAll("#popup-button");
        const popupContent = document.querySelector("#popup-snow");
        document.querySelector(".popup__close");
        for (let index = 0; index < popupButton.length; index++) popupButton[index].addEventListener("click", (function(e) {
            popupContent.classList.add("_open-popup");
        }));
        window["FLS"] = false;
        isWebp();
        menuInit();
